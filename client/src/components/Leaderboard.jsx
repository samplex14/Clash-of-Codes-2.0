        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-white">
            {players.map((player, index) => {
              ...
              const isQualified = player.phase1Qualified;
              ...
              return (
                ...
                >
                  ...
                  <td className="p-4 text-gray-300">{player.track === '1st_year' ? '1st Year' : '2nd Year'}</td>
                  <td className="p-4 font-clash text-clash-gold text-xl">{player.phase1Score}</td>
                  <td className="p-4 font-mono">{player.phase1Time.toFixed(1)}s</td>
                </tr>
              );
            })}
          </tbody>
